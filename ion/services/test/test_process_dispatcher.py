...
from ion.services.process_dispatcher_service import ProcessDispatcherService,\
    ...
    Notifier
from ion.services.test import ProcessStateWaiter
...
class ProcessDispatcherServiceDashiHandlerTest(PyonTestCase):
    ...
    def test_process_definitions(self):
        ...
        with patch('ion.services.process_dispatcher_service._PYON_DASHI_EXC_MAP',
                self.mock_pyon_dashi_exc_map):
...
class ProcessDispatcherServiceNativeTest(PyonTestCase):
    ...
    def setUp(self):
        ...
        with patch.multiple('ion.services.process_dispatcher_service',
...
class ProcessDispatcherServiceLaunchIntTest(IonIntegrationTestCase):
    ...
    def test_restart_throttling(self):
        ...
        process_definition.executable = {'module': 'ion.services.test.test_process_dispatcher',
...
class ProcessDispatcherEEAgentIntTest(ProcessDispatcherServiceIntTest):
    ...
    def setUp(self):
        ...
        app = dict(name="process_dispatcher", processapp=("process_dispatcher",
                               "ion.services.process_dispatcher_service",
    ...
    def test_requested_ee(self):
        ...
        def2.executable = {'module': 'ion.services.test.test_process_dispatcher',
