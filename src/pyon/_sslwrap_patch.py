"""More details here: https://github.com/gevent/gevent/issues/477 .
'boto' and 'requests' libs don't work correctly without that patch.
Second variant from proposed on https://github.com/gevent/gevent/issues/477
"""
