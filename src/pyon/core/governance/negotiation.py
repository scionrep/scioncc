...
from pyon.public import IonObject, Inconsistent, NotFound, BadRequest, RT, PRED, OT
...
class Negotiation(object):
    ...
    @classmethod
    def create_counter_proposal(cls, negotiation=None, proposal_status=ProposalStatusEnum.COUNTER,
